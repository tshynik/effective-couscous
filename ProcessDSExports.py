...
def formatfile(infilename, outfilename):
	...
	try:
		...
		messaging("Error: Access denied. Make sure the output file %s is not open already in another program, or name your output something else." % outfilename )
		return("error")
